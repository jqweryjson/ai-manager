import { getUserTelegramAccounts, getTelegramAccount, deleteTelegramAccount, } from "../../../core/telegram-account-postgres.js";
...
export async function handleDisconnect(fastify, request, reply) {
    try {
        ...
        fastify.log.info(`🗑️  Telegram аккаунт удалён: ${account_id} для пользователя ${request.userId}`);
        return {
            success: true,
        };
    }
