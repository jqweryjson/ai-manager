 ...
 * @returns TelegramClient
 */
export declare function restoreSession(
  sessionString: string,
  apiId: number,
  apiHash: string
): TelegramClient;
 ...
 */
export declare function getDialogsSummary(
  client: TelegramClient,
  limit?: number,
  offsetDate?: Date
